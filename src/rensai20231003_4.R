...
write.csv(data_fig, "../Nikkei Glocal/out/jpn_popmomentum_popest.csv")

data_fig %>% 
  ggplot(aes(x = year, y = pop, group = type, linetype = type)) +
  geom_line(size = 1.2) +
...
ggsave("../Nikkei Glocal/out/jpn_popmomentum_popest.png", width = 7.5, height = 5, bg = "white")
